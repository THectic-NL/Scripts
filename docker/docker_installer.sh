...
Test-MutableOs "Docker" \
    "Podman ships with most image-based systems and is Docker-compatible" \
    "Layer it onto the image: rpm-ostree install docker docker-compose" \
    "On openSUSE MicroOS: transactional-update pkg install docker"
